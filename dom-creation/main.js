...
function renderPokemon(pokemon) {
  ...
  var newClone = newDiv.cloneNode();
  newClone.setAttribute('class', 'pokemon-card');
  newDiv.appendChild(newClone);
  var newImg = document.createElement('img');
  newImg.setAttribute('src', pokemon.imageUrl);
  newClone.appendChild(newImg);
  var newClone2 = newClone.cloneNode();
  newClone2.setAttribute('class', 'pokemon-card-text');
  newClone.appendChild(newClone2);
  var newH2 = document.createElement('h2');
  var h2Text = document.createTextNode(pokemon.name);
  newH2.appendChild(h2Text);
  newClone2.appendChild(newH2);
  var newH3 = document.createElement('h3');
  var h3Text = document.createTextNode(pokemon.number);
  newH3.appendChild(h3Text);
  newClone2.appendChild(newH3);
  var newP = document.createElement('p');
  var pText = document.createTextNode(pokemon.description);
  newP.appendChild(pText);
  newClone2.appendChild(newP);
  return newDiv;
}
